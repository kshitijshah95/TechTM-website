...
if($_POST)
{
    $to_Email       = "techtmco@gmail.com"; //Replace with recipient email address
    $subject        = 'Techtm Support'; //Subject line for emails
    ...
    */
    ...
    if(!$sentMail)
    {
        ...
        $output = json_encode(array('type'=>'message', 'text' => 'Hi '.$user_Name .' Thank you for your Support. We will get back to your soon.'));
        die($output);
    }
}
?>